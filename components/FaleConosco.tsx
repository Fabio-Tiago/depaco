...
/**
 * Bloco de fechamento do post: botao grande de WhatsApp + redes sociais.
 * Numero e links vem de env vars (NEXT_PUBLIC_*).
 */
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-ink">
              <path d="M16.5 5.5a4.5 4.5 0 0 0 3.5 1.7V10a7.7 7.7 0 0 1-3.5-.9v5.4a5.5 5.5 0 1 1-5.5-5.5c.3 0 .6 0 .9.1v2.9a2.6 2.6 0 1 0 1.8 2.5V2h2.8a4.5 4.5 0 0 0 .5 3.5z" />
            </svg>
          </a>
